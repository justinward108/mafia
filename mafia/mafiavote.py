...
log = logging.getLogger("red.justinward.mafiamafiavote")


class MafiaVote(VoteGroup):
    """
    Mafia implementation of base VoteGroup class
    """

    alignment = 2  # 1: Town, 2: Mafia, 3: Neutral
    channel_id = "mafia"
