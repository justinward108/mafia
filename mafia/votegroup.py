...
log = logging.getLogger("red.justinward.mafia.votegroup")


class VoteGroup(MafiaListener):
    """
    Base VoteGroup class for mafia game
    Handles secret channels and group decisions
    """

    alignment = 0  # 1: Town, 2: mafia, 3: Neutral
    channel_id = ""
    ...
    @mafialistener("at_night_end", priority=5)
