...
Role Constants
    ...
    Role Alignment guide as follows:
        ...
        (Rival mafias, cultists, vampires)
    ...
    Role Category enrollment guide as follows (See Role.category):
        ...
        category = [11, 16] Could be mafia Silencer
...
ALIGNMENT_MAFIA = 2
ALIGNMENT_NEUTRAL = 3
ALIGNMENT_MAP = {"Town": 1, "Mafia": 2, "Neutral": 3}

# 0-9: Town Role Categories
# 10-19: mafia Role Categories
...
CATEGORY_MAFIA_RANDOM = 11
CATEGORY_MAFIA_DECEPTION = 12
CATEGORY_MAFIA_KILLING = 15
CATEGORY_MAFIA_SUPPORT = 16
...
ROLE_CATEGORY_DESCRIPTIONS = {
    ...
    CATEGORY_MAFIA_RANDOM: "Random",
    CATEGORY_MAFIA_DECEPTION: "Deception",
    CATEGORY_MAFIA_KILLING: "Killing",
    CATEGORY_MAFIA_SUPPORT: "Support",
...
Listener Actions Priority Guide
    ...
    Action priority guide as follows (see listeners.py for mafialistener):
        _at_night_start
        0. No Action
