...
from mafia.constants import ALIGNMENT_NEUTRAL, CATEGORY_NEUTRAL_BENIGN
from mafia.mafialistener import MafiaListener, mafialistener
from mafia.night_powers import pick_target
from mafia.role import Role

log = logging.getLogger("red.justinward.mafiashifter")


class Shifter(Role):
    """
    Base Role class for mafia game
    ...
    alignment = ALIGNMENT_NEUTRAL  # 1: Town, 2: Mafia, 3: Neutral
    ...
    async def see_alignment(self, source=None):
        ...
        to see alignment (Village, Mafia,, Other)
        """
        return "Other"
