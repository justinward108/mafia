...
log = logging.getLogger("red.justinward.mafia")
...
class mafia(Cog):
    ...
    @commands.command()
    async def buildnewgame(self, ctx: commands.Context):
        """
    ...
    @checks.guildowner()
    @commands.group()
    async def mafiaset(self, ctx: commands.Context):
        """
    ...
    @commands.guild_only()
    @mafiaset.command(name="list")
    async def mafiaset_list(self, ctx: commands.Context):
        """
    ...
    @commands.guild_only()
    @mafiaset.command(name="role")
    async def mafiaset_role(self, ctx: commands.Context, role: discord.Role = None):
        """
        Set the game role
    ...
    @commands.guild_only()
    @mafiaset.command(name="category")
    async def mafiaset_category(self, ctx: commands.Context, category_id: int = None):
        """
    ...
    @commands.guild_only()
    @mafiaset.command(name="channel")
    async def mafiaset_channel(self, ctx: commands.Context, channel: discord.TextChannel = None):
        """
    ...
    @commands.guild_only()
    @mafiaset.command(name="logchannel")
    async def mafiaset_log_channel(self, ctx: commands.Context, channel: discord.TextChannel = None):
        """
    ...
    async def mafia_new(self, ctx: commands.Context, game_code=None):
        """
        Create and join a new game of mafia
        """
    ...
    @commands.guild_only()
    @commands.admin()
    @mafia.command(name="forcejoin")
    async def mafia_forcejoin(self, ctx: commands.Context, target: discord.Member):
        """
        Force someone to join a game of mafia
        """
    ...
    @commands.guild_only()
    @mafia.command(name="code")
    async def mafia_code(self, ctx: commands.Context, code):
        """
    ...
    @commands.guild_only()
    @mafia.command(name="quit")
    async def mafia_quit(self, ctx: commands.Context):
        """
    ...
    async def mafia_vote(self, ctx: commands.Context, target_id: int):
        """
        ...
        #             break #game = game
        #     else:
        #         await ctx.send("You're not part of any mafia game")
        #         return
        # else:
    ...
    @mafia.command(name="choose")
    async def mafia_choose(self, ctx: commands.Context, data):
        """
        ...
        for game in self.games.values():
            ...
            await ctx.maybe_send_embed("You're not part of any mafia game")
            return

        await game.choose(ctx, data)

    @mafia.group(name="search")
    async def mafia_search(self, ctx: commands.Context):
        """
    ...
    @mafia_search.command(name="name")
    async def mafia_search_name(self, ctx: commands.Context, *, name):
    ...
    @mafia_search.command(name="alignment")
    async def mafia_search_alignment(self, ctx: commands.Context, alignment: int):
    ...
    @mafia_search.command(name="category")
    async def mafia_search_category(self, ctx: commands.Context, category: int):
    ...
    @mafia_search.command(name="index")
    async def mafia_search_index(self, ctx: commands.Context, idx: int):
