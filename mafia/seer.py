...
log = logging.getLogger("red.justinward.mafia.seer")
...
class Seer(Role):
    ...
    alignment = ALIGNMENT_TOWN  # 1: Town, 2: Mafia, 3: Neutral
    ...
    @mafialistener("at_night_end", priority=4)
    async def _at_night_end(self):
        ...
        if alignment == ALIGNMENT_MAFIA:
            out = "Your insight reveals this player to be a mafia!**"
